          ...
          <div class=row id= 'body'>
                ...
                <form action=""method="POST">
                  ...
                  <tr>
                      ...
                      <td>
                          <input type = 'number' id="input"name = 'cell' required min="10" max="999999999999">
                      </td>
                  </tr>
                  <tr>
                      <td>
                      ...
                      <td>
                          <input type="password" name="pwd" value="" required id="pass1">
                      </td>
                  </tr>
                  <tr>
                      <td>
                      ...
                      <td>
                        <input type="password" name="" value="" required id="pass2" onkeyup= "checkPass(); return false";>

                      </td>
                  </tr>
                  <tr>  <td></td>
                      <td>
                            <input type ='submit' name = 'submit' value='Update' id ='button_body'>
                      </td>
                  </tr>
                </table><br>
